...
<span style="position:absolute;left:160px;top:600px" class="cls_003">'.$_POST['tenant_name'].'</span>
...
<span style="position:absolute;left:465px;top:765px" class="cls_004"><img style="position:absolute; top:-30px; left:25px;" width="160" height="65" src="'.$_POST['signature_source'].'"/><span class="cls_004">(Signature of Plaintiff or Authorized Agent)</span></span>
