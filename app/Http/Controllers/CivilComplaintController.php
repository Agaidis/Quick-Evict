...
<span style="position:absolute;left:55px;top:720px" class="cls_003"><span class="cls_003">I, ____________'.$_POST['tenant_name'].'______________ verify that the facts set forth in this complaint are true and correct to the</span></span>
<span style="position:absolute;left:55px;top:737px" class="cls_003"><span class="cls_003">best of my knowledge, information, and belief.  This statement is made subject to the penalties of Section 4904 of the</span></span>
<span style="position:absolute;left:55px;top:750px" class="cls_003"><span class="cls_003">Crimes Code (18 PA. C.S. § 4904) related to unsworn falsification to authorities.</span></span>
<span style="position:absolute;left:55px;top:777px" class="cls_003"><span class="cls_003">I certify that this filing complies with the provisions of the Case Records Public Access Policy of the Unified Judicial System</span></span>
<span style="position:absolute;left:55px;top:794px" class="cls_003"><span class="cls_003">of Pennsylvania that require filing confidential information and documents differently than non-confidential information and</span></span>
<span style="position:absolute;left:55px;top:812px" class="cls_003"><span class="cls_003">documents.</span></span>
...
<span style="position:absolute;left:55px;top:850px" class="cls_007"><span class="cls_007">If you intend to enter a defense to this complaint, you should notify this office immediately at the above telephone number.  You</span></span>
<span style="position:absolute;left:55px;top:865px" class="cls_007"><span class="cls_007">must appear at the hearing and present your defense.  Unless you do, judgment may be entered against you by default.</span></span>
<span style="position:absolute;left:55px;top:880px" class="cls_004"><span class="cls_004">If you have a claim against the plaintiff which is within the magisterial district judge jurisdiction and which you intend to assert at the</span></span>
<span style="position:absolute;left:55px;top:895px" class="cls_004"><span class="cls_004">hearing, you must file it on a complaint form at this office at least five days before the date set for the hearing.</span></span>
<span style="position:absolute;left:55px;top:910px" class="cls_007"><span class="cls_007">If you are disabled and require a reasonable accommodation to gain access to the Magisterial District Court and its services,</span></span>
<span style="position:absolute;left:55px;top:925px" class="cls_007"><span class="cls_007">please contact the Magisterial District Court at the above address or telephone number.  We are unable to provide</span></span>
<span style="position:absolute;left:55px;top:940px" class="cls_007"><span class="cls_007">transportation.</span></span>
