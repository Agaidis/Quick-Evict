...
<span style="position:absolute;left:55px;top:600px" class="cls_003"><span class="cls_003">I, <span style="text-decoration:underline;">'  . $verifyName .  '  </span>verify that the facts set forth in this complaint are true and correct to the</span></span>
