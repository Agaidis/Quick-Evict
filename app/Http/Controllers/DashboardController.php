        ...
        try {
            ...
            if (Auth::user()->role == 'Administrator') {
                ...
                $evictions = DB::table('evictions')
                    ->select('evictions.id', 'users.name AS name', 'user_id', 'property_address', 'status', 'court_details.county', 'file_type', 'is_downloaded', 'owner_name', 'tenant_name', 'court_date', 'total_judgement', 'filing_fee',  'evictions.created_at', 'is_extra_files', 'court_number', 'is_in_person_filing')
