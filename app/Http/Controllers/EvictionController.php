...
<span style="position:absolute;left:55.40px;top:820.90px" class="cls_004"><span class="cls_004">I certify this filing complies with the UJS Case Records Public Access Policy.</span></span><br><img style="position:absolute" width="200" height="75" src="'.$_POST['signature_source'].'"/>
<span style="position:absolute;left:560.00px;top:870.80px" class="cls_004"><span class="cls_004">(Signature of Plaintiff)</span></span><br><img width="200" height="75" src="'.$_POST['signature_source'].'"/>
