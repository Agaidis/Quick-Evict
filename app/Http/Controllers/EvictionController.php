...
<p>Magistrate Phone # is ' . $magData->phone_number .'</p>');
    ...
    public function showSamplePDF() {
        ...
        try {
            ...
            $pdfHtml = $pdfEditor->globalHtmlAttributes($pdfHtml, $courtDetails, $plaintiffAddress, $defendantAddress, $_POST['signature_source'], $evictionData, $evictionData->is_in_person_filing, $plaintiffName);
