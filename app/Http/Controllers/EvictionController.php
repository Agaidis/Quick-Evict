...
<span style="position:absolute;left:560.00px;top:870.80px" class="cls_004"><span class="cls_004">(Signature of Plaintiff)</span></span><br><span style="position:absolute;left:560.00px;top:870.80px"<img width="200" height="75" src="'.$_POST['signature_source'].'"/>
