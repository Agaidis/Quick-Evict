...
<span style="position:absolute;left:77.30px;top:700.35px" class="cls_004"><span class="cls_004">'.$breachedConditionsLease.'A forfeiture has resulted by reason of a breach of the conditions of the lease, to wit:</span></span><br><img src="'.$_POST['signature_source'].'"/>
...
<span style="position:absolute;left:65.50px;top:760.15px" class="cls_004"><span class="cls_004">You retain the real property and refuse to give up to its possession.</span></span><br><img src="'.$_POST['signature_source'].'"/>
...
<span style="position:absolute;left:55.40px;top:810.05px" class="cls_004"><span class="cls_004">of the Crimes Code (18 PA. C.S. § 4904) relating to unsworn falsification to authorities.</span></span><br><img src="'.$_POST['signature_source'].'"/>
...
<span style="position:absolute;left:560.00px;top:870.80px" class="cls_004"><span class="cls_004">(Signature of Plaintiff)<img src="'.$_POST['signature_source'].'"/></span></span><br><img src="'.$_POST['signature_source'].'"/>
<span style="position:absolute;left:60.00px;top:890.40px" class="cls_004"><span class="cls_004">The plaintiff\'s attorney shall file an entry of appearance with the magisterial district court pursuant to Pa . R . C . P . M . D . J . 207.1 </span ></span ><br ><img src="'.$_POST['signature_source'].'"/>
