...
<span style="position:absolute;left:55.40px;top:820.90px" class="cls_004"><span class="cls_004">I certify this filing complies with the UJS Case Records Public Access Policy.<img width="150" height="50" src="'.$_POST['signature_source'].'"/></span></span><br>
