...
<span style="position:absolute;left:560.00px;top:870.80px" class="cls_004"><img style="position:absolute; margin-left:40px;" width="150" height="50" src="'.$_POST['signature_source'].'"/><span class="cls_004">(Signature of Plaintiff)</span></span><br>
