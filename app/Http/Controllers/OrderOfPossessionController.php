...
<span style="position:absolute;left:215.00px;top:180.75px" class="cls_003"><span class="cls_003">$_</span><p style="text-decoration:underline">'. $_POST['judgment_amount'] .'</p></span>
<span style="position:absolute;left:39.00px;top:195.75px" class="cls_004"><span class="cls_004">Costs in Original LT Proceeding</span></span>
<span style="position:absolute;left:215.00px;top:195.75px" class="cls_003"><span class="cls_003">$_</span>'. $_POST['costs_original_lt_proceeding'] .'</span>
...
<span style="position:absolute;left:215.00px;top:245.55px" class="cls_003"><span class="cls_003">$_</span>'. $_POST['costs_this_proceeding'] .'</span>
<span style="position:absolute;left:109.85px;top:259.05px" class="cls_004"><span class="cls_004">Attorney Fees</span></span>
<span style="position:absolute;left:215.00px;top:259.55px" class="cls_003"><span class="cls_003">$_</span>'. $_POST['attorney_fees'] .'</span>
<span style="position:absolute;left:147.00px;top:288.75px" class="cls_004"><span class="cls_004">Total</span></span>
<span style="position:absolute;left:215.00px;top:288.55px" class="cls_003"><span class="cls_003">$_</span>'. $totalFees .'</span>
...
<span style="position:absolute;left:36.00px;top:644.14px" class="cls_004"><span class="cls_004">Requests that you issue an ORDER FOR POSSESSION for such property.</span></span>
...
<span style="position:absolute;left:400.00px;top:710.40px" class="cls_004"><span class="cls_004">Date:</span> '. date("d/m/Y") .'</span>
<span style="position:absolute;left:400.00px;top:740.55px" class="cls_004"><span class="cls_004">Plaintiff Signature:</span><img style="position:absolute;" width="160" height="65" src="'.$_POST['signature_source'].'"/></span>
<span style="position:absolute;left:55.40px;top:860.50px" class="cls_007"><span class="cls_007">AOPC 311A</span></span>
<span style="position:absolute;left:535.75px;top:860.50px" class="cls_008"><span class="cls_008">FREE INTERPRETER</span></span>
<span style="position:absolute;left:535.75px;top:875.50px" class="cls_009"><span class="cls_009">www.pacourts.us/language-rights</span></span><br>
<span style = "position:absolute;left:293.75px;top:860.50px" class="cls_008" ><span class="cls_008" > CourtZip ID # </span ></span ><br >
</span></body></html>
');
