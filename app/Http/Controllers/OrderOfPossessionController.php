...
class OrderOfPossessionController extends Controller
{
    ...
    public function showSamplePDF() {
        ...
        try {
            ...
            $pdfHtml = $pdfEditor->globalHtmlAttributes($pdfHtml, $courtDetails, $plaintiffAddress, $defendantAddress, $_POST['signature_source'], $evictionData, $evictionData->is_in_person_filing, $evictionData->plantiff_name);
