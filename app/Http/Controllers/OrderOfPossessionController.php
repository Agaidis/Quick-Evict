...
<span style="position:absolute;left:450px;top:190px" class="cls_005"><span class="cls_005">DEFENDANT:</span><p style="margin-left:65px;">'. $_POST['tenant_name'].'<br>'.$defendanthouseNum.' '.$defendantStreetName.' '. $_POST['unit_number'] . '<br>'.$defendantTown .',' . $defendantState.' '.$defendantZipcode.'  </p></span>
