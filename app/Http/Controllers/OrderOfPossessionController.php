...
<span style="position:absolute;left:500.25px;top:37px" class="cls_002"><span class="cls_002">REQUEST FOR ORDER FOR</span></span>
<span style="position:absolute;left:50.05px;top:51px" class="cls_003"><span class="cls_003">COUNTY OF ' . strtoupper($courtDetails->county) .'</span></span><br>
<span style="position:absolute;left:500.80px;top:55px" class="cls_002"><span class="cls_002">POSSESSION</span></span>
...
<span style="position:absolute;left:450.90px;top:230px" class="cls_005"><span class="cls_005">PLANTIFF:</span><br><p style="margin-left:6px;">'. $plantiffName .'<br>'. $plantiffAddress1 .'<br>'. $plantiffAddress2 .'<br>'.$plantiffPhone.'</p></span>
<span style="position:absolute;left:500.90px;top:180px" class="cls_005"><span class="cls_005">V.</span></span>
<span style="position:absolute;left:400.90px;top:250px" class="cls_005"><span class="cls_005">DEFENDANT:</span><br><p style="margin-left:6px;">'. $_POST['tenant_name'].'<br>'.$defendanthouseNum.' '.$defendantStreetName.' '. $_POST['unit_number'] . '<br>'.$defendantTown .',' . $defendantState.' '.$defendantZipcode.'  </p></span>
<span style="position:absolute;left:40.90px;top:250px" class="cls_004"><span class="cls_004">Address: '.$courtAddressLine1.'<br><span style="margin-left:45px;">'.$courtAddressLine2.'</span></span>
<span style="position:absolute;left:40.90px;top:165px" class="cls_004"><span class="cls_004">Telephone:</span></span>
...
<span style="position:absolute;left:86.00px;top:210px" class="cls_004"><span class="cls_004">Costs in this Proceeding</span></span>
...
<span style="position:absolute;left:139.85px;top:225px" class="cls_004"><span class="cls_004">Attorney Fees</span></span>
<span style="position:absolute;left:215.00px;top:225px" class="cls_003"><span class="cls_003">$_</span>'. $_POST['attorney_fees'] .'</span>
<span style="position:absolute;left:187.00px;top:240px" class="cls_004"><span class="cls_004">Total</span></span>
