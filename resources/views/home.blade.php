            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <ul>
                                <li><strong>Geo-Coded Local Court Zones</strong>: Local civil complaints must be filed in the correct court, which is often confusing. CourtZip has geo-coded each address into the specific court to be filed. The owner or property manager just types in the address and CourtZip matches the address to the proper court --- never have to call the court again or file in the wrong place!<br /><br /></li>
