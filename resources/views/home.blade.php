            ...
            <div style="margin-top:-5%;" class="container">
                <div class="row" style="margin-bottom:10%;">
                    ...
                    <div class="col-md-12 col-lg-8 col-xl-7 mx-auto">
                        <form method="post" class="form-horizontal" id="new_file_form">
                            <input type="hidden" name="_token" value="{{ Session::token() }}">
                            <h3>File online today!</h3>
                            <div class="form-row">
                                <button type="button" style="background-color:#283891;" class="btn btn-default offset-4" onclick="window.location='{{ url("register") }}'" id="create_an_account">Create an Account</button>
