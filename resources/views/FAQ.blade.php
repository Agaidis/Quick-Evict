                ...
                <div class="card-body body_container">
                    ...
                    <div class="row" style="margin-left: 6%; margin-right: 6%;">
                        ...
                        <div>
                            ...
                            <p><strong>What does CourtZip do?</strong><br />CourtZip's first product is to make it easier and faster to successfully file a Civil Complaint (under $12,000), Landlord-Tenant Complaint, or Order of Possession in one of Pennsylvania's Magisterial District Courts. CourtZip has a back-end database to match the address of the property to the proper Magisterial District Court. CourtZip has compiled a database for every District Court so the filing fee is automatically generated. Once the fields are filled in and the user hits the submit button -- a full civil complaint, LTC, or OOP form is completed. This form is then filed online by CourtZip.<br /><br />
                                <span style="font-size:12px;">"To start a new file today, <a href="{{ url('new-file') }}">click here</a>"  -- with the link going to start a new file</span>
                            </p>
                            ...
                            <p><strong>Where does this work? </strong>CourtZip will be live on Dec 1, 2019 in Lancaster County, PA and Jan 1, 2020 in York County, PA. CourtZip will be rolling out new counties and states in the near future --- with a goal of eventually working in every District Court in the country.</p>
