        ...
        <div class="row">
            <div class="col-md-12 col-lg-10 col-xl-10 mx-auto">
                ...
                <div>
                    ...
                    <div style="background-color:#ccccd2; border-radius: 2em; padding:5px;">
                    ...
                    <h2 style="text-align:center; margin-top:3%;">OR</h2>

                    <h4 style="margin-top:3%;">*$225-Landlord Tenant Complaint Filing + Court Representation</h4>
                    ...
                    <h4 style="margin-top:3%;">*$275 - Order for Possession Filing + Lock Out Attendance and Lock Change</h4>
