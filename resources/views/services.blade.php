    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-10 col-xl-10 mx-auto">
                ...
                <div class="row">
                    <div>The eviction process can be a confusing, time consuming, and expensive process.  CourtZip was created to simplify this process at a reasonable price.  We have built first party tech that automates much of this process and in some courts happens in real time eliminating wasted processing time in the mail.  We can simply assist in the filings or we can take it the whole way and deliver you a vacant secured property. The level of service is your choice</div>

                    <h2>Step 1 - File the LandLord Tenant Complaint</h2>
                    <div>(You can start this process for any tenant with a past due balance)</div>

                    <h4>$25- Landlord Tenant Complaint Filing Only</h4>

                    <div>You will fill out a form online asking for all relevant information(address, tenant name, delinquency amount, etc.).  The court fees are automatically calculated which vary depending on the number of defendants, location, and balance. The form is converted to a court approved document.  Next, you will pay the court costs and $25 service fee through our site.  Upon payment, the form will be filed electronically or by courier within 24 hrs.  Within a few business days the court will set a court date and we will notify you by US Mail.  You will attend court and represent yourself approximately 2-3 weeks after you submit this form.</div>

                    <h2 style="text-align:center;">OR</h2>

                    <h3>*$225-Landlord Tenant Complaint Filing + Court Representation</h3>

                    <div>This service adds court representation to the LTC Filing Service.  The initial process is the same as above except for an added cost of $200.  Additionally, you will be sent an authorization of representation form to fill out electronically.  This gives Courtzip permission to represent you in court.  You do not need to attend court but can if you like. </div>

                    <h2>Step 2 - File the Order for Possession</h2>
                    ...
                    <h3>$25- Order for Possession Filing Only</h3>
                    ...
                    <h3>*$275 - Order for Possession Filing + Lock Out Attendance and Lock Change</h3>

                    <div>This service adds representation and lock changes to the OP Filing Service.  The initial process is the same as above with a CourtZip agent attending the lock out and changing the locks for an added cost of $250.  You do not need to attend the lockout but can if you like.  We can mail you a copy of the new key or leave a copy in a lockbox at the property. </div>
