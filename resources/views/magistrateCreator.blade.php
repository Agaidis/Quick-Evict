                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-responsive-lg table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center magistrate-remove"><a href="javascript:void(0)" id="id_{{$courtDetail->id}}_{{$courtDetail->court_number}}" class="text-danger magistrate-remove"><span style="border: 1px solid grey; border-radius:10em;" class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span><b>X</b></a></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
