                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-responsive-lg table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="javascript:void(0)" class="text-danger magistrate-remove"><span style="border: 1px solid grey; border-radius:10em;" class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>X</a></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
