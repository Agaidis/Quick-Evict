                                        ...
                                        <td class="text-center">
                                            ...
                                            @endif
                                                ...
                                                @if ($userRole != 'Court')
                                                    ...
                                                    <button type="button" id="eviction_details_{{$eviction->id}}" data-target="#seeFilingDetailsModal" data-toggle="modal" class="eviction_details btn-sm btn-light fa fa-newspaper"></button>
                                                @endif
                                        </td>
