                                ...
                                @foreach ($evictions as $eviction)
                                    ...
                                    <tr>
                                        ...
                                        @if (Auth::user()->role == 'Administrator')
                                            @if (in_array($eviction->court_number, $notesArray))
                                        ...
                                        <td class="text-center">
                                            ...
                                            @endif
                                                ...
                                                @if ($userRole != 'Court')
                                                    ...
                                                    <button type="button" style="margin-top:10px; float:left;" id="eviction_details_{{$eviction->id}}" data-target="#seeFilingDetailsModal" data-toggle="modal" class="eviction_details btn btn-info fa fa-newspaper"></button>
                                                @endif
                                        </td>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="offset-1 col-md-10">
                                    ...
                                    <textarea id="new_eviction_note"></textarea><br>
                                    <input type="hidden" id="eviction_id" value=""/>
                                    <button type="button" id="submit_eviction_note" class="approve-btn btn btn-success">Add Note</button>
                                </div>
                                <div class="offset-1 col-md-10">
